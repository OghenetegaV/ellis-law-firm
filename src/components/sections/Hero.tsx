...
export function Hero() {
  return (
    <section className={`${cormorant.variable} relative bg-white`}>
      <div className="grid lg:grid-cols-[minmax(0,58%)_minmax(0,42%)]">
        <div className="flex flex-col justify-center px-5 py-16 sm:px-6 sm:py-20 md:px-[7vw] md:py-24 lg:min-h-[calc(100vh-77px)] lg:py-0">
          <Reveal>
          ...
          <Reveal delay={100}>
            ...
            >
              ...
              <span className="block text-burgundy">Is Significant.</span>
            </h1>
          </Reveal>
        ...
        <Reveal delay={150} className="relative min-h-[300px] sm:min-h-[420px] lg:min-h-full">
          <div className="relative h-full min-h-[300px] w-full sm:min-h-[420px] lg:min-h-full">
            <Image
